<?php
/*
Plugin Name:  Secure Password Login
...
function integrate_CHAP_login_form(){
	...
	<div style="border-width:0px;text-decoration:none;"  >
		<img style="border-width:0px;text-decoration:none;height:20px;width:20px;position:relative;float:left;margin-top:-80px;margin-left:80px;" alt="> Encryption password!" src="<?php echo plugins_url( 'lock.png', __FILE__ ); ?>">
	</div>
