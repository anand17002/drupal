...
// To remove all update features either Theme , Core ot Plugins
...
// to remove "Thank you for creating with WordPress" message 
function wpse_edit_footer() {
    add_filter( 'admin_footer_text', 'wpse_edit_text', 11 );
}

function wpse_edit_text($content) {
    return "Welcome to DPE Blog's Admin Panel. ";
}
...
add_action( 'login_form', 'blog_login_form' );
...
function my_login_logo_url_title() {
    return 'The Bloging System for Department of Public Enterprises';
}
add_filter( 'login_headertitle', 'my_login_logo_url_title' );


///**** hashing ushi shas1 methods

//****** remove wordpress logo from admin pannel 
add_action( 'admin_bar_menu', 'remove_wp_logo', 999 );

function remove_wp_logo( $wp_admin_bar ) {
	$wp_admin_bar->remove_node( 'wp-logo' );
}
///****login page costomization 
