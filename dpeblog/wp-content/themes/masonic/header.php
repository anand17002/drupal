         ...
         <header id="masthead" class="site-header clear">
            ...
            <div class="header-image">
               <?php if (get_header_image()) : ?>
                  <figure><img src="<?php header_image(); ?>"  alt="">
               ...
               <div class="wrapper site-header-text clear">
                  <?php if (get_theme_mod('masonic_logo')) : ?>
                     <div class="logo-img-holder " >
                        <a  href='<?php echo esc_url(home_url('/')); ?>' title='<?php echo esc_attr(get_bloginfo('name', 'masonic')); ?>' rel='home'><img src='<?php echo esc_url(get_theme_mod('masonic_logo')); ?>' alt='<?php echo esc_attr(get_bloginfo('name', 'masonic')); ?>'>
                        </a>
                     </div>
                  <?php endif; ?>
